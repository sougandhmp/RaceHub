...
class ObserveDriverStandingsUseCase(private val repository: RaceRepository) {
    operator fun invoke(): Flow<List<DriverStanding>> = repository.observeDriverStandings()
}
