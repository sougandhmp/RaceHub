...
class ObserveConstructorStandingsUseCase(private val repository: RaceRepository) {
    operator fun invoke(): Flow<List<ConstructorStanding>> = repository.observeConstructorStandings()
}
